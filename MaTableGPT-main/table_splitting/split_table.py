...
class DivideHtml() : 
    ...
    def case_1(self,file_name, origin_head, origin_body, body_h_b_list) : 
        '''
    ...
    def case_2(self,file_name, origin_head, origin_body, body_h_b_list) :
        '''
    ...
    def case_3(self,file_name, origin_head, origin_body, body_h_b_list) : 
        '''
    ...
    def normal(self,file_name, origin_head, origin_body) : 
        '''
        Normal table
        '''
        table_final = []
    ...
    def run(self) : 
        ...
        if all(element == 'body' for element in row_h_b_list) :      
            ######### normal #########
            self.normal(f_name, origin_head, origin_body)
            ...
            if row_h_b_list[0] == 'head' : 
                ...
                if 'body' not in row_h_b_list : 
                    ...
                    if last_head == row_h_b_list.count('head') - 1:
                        ######### case 1 #########
                        self.case_1(f_name, origin_head, origin_body, row_h_b_list)
           
                    else : 
                        ######### case 2 #########
                        if origin_head == None : 
                            self.case_2(f_name, origin_head, origin_body, row_h_b_list)
                        ######### case 3 #########
                        else : 
                            self.case_3(f_name, origin_head, origin_body, row_h_b_list)
            else : 
                ######### case 2 #########
                self.case_2(f_name, origin_head, origin_body, row_h_b_list)
